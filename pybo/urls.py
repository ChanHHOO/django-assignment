...
urlpatterns = [
    ...
    path('vote/question_comment/<int:comment_id>/', vote_views.voter_question_comment, name='vote_question_comment'),
    path('vote/answer_comment/<int:comment_id>/', vote_views.voter_answer_comment, name='vote_answer_comment'),
]
